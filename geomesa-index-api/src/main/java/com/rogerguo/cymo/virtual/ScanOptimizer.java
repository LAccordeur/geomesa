...
public class ScanOptimizer {
    ...
    // only for full
    public ScanOptimizer(SubspaceLocation subspaceLocation) {
    ...
    public ScanOptimizer(SubspaceLocation subspaceLocation, List<Long> sortedCellIDListInTheSubspace, List<Long> extraSortedCellIDListInTheSubspace, List<Long> sortedCellIDListInQueryRange) {
        this.subspaceLocation = subspaceLocation;
        this.partitionID = subspaceLocation.getPartitionID();
        this.subspaceID = VirtualSpaceTransformationHelper.toSubspaceID(subspaceLocation.getSubspaceLongitude(), subspaceLocation.getSubspaceLatitude());
        this.subScanItemList = new ArrayList<>();
    ...
    // only used for split
    public ScanOptimizer(SubspaceLocation subspaceLocation, SubScanRange initLargeScanRangeInQueryRange, List<Long> sortedCellIDListOutTheSubspace, List<Long> extraSortedCellIDListOutTheSubspace) {
        this.subspaceLocation = subspaceLocation;
        this.partitionID = subspaceLocation.getPartitionID();
        this.subspaceID = VirtualSpaceTransformationHelper.toSubspaceID(subspaceLocation.getSubspaceLongitude(), subspaceLocation.getSubspaceLatitude());
        this.subScanItemList = new ArrayList<>();
    ...
    public ScanOptimizer(SubspaceLocation subspaceLocation, List<Long> sortedCellIDListInQueryRange) {
        this.subspaceLocation = subspaceLocation;
        this.partitionID = subspaceLocation.getPartitionID();
        this.subspaceID = VirtualSpaceTransformationHelper.toSubspaceID(subspaceLocation.getSubspaceLongitude(), subspaceLocation.getSubspaceLatitude());
        this.subScanItemList = new ArrayList<>();
